...
import { User, Mail, Phone, Calendar, MapPin, Edit, ChevronRight } from 'lucide-react';
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        ...
                        <p className="text-lg font-semibold text-gray-800 dark:text-white">{perfilData.nombre} {perfilData.apellido}</p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Género</p>
                        <p className="text-lg font-semibold text-gray-800 dark:text-white">{perfilData.genero}</p>
                    </div>
                </div>
                    ...
                    <div className="divide-y divide-gray-200 dark:divide-gray-700">
                        <div className="flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-md text-gray-800 dark:text-white">{perfilData.correo}</p>
                            </div>
                        </div>
                        <div className="flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-md text-gray-800 dark:text-white">{perfilData.telefono}</p>
                            </div>
                        </div>
                        <div className="flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-md text-gray-800 dark:text-white">{perfilData.fechaNacimiento}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div className="p-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-800 dark:text-white">{perfilData.direccion.calle}</p>
                                <p className="text-gray-600 dark:text-gray-400">{perfilData.direccion.ciudad}, CP {perfilData.direccion.codigoPostal}</p>
                            </div>
                        </div>
                    </div>
                </div>
